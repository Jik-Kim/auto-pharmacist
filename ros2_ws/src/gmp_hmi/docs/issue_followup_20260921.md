...
| #137 잔량·보충 | 시험 백엔드·세션 추정 유지. 잔량·보충 UI는 화면에 있음(PR #176에서 숨겼다가 `bafb9b4`로 복구) | B/C 운영 재고 계약·실물 높이 보정 |
| #161 레시피 | 시험 YAML 3종 존재. 운영 경로는 PR #217로 등록 완료 | 목표·허용폭은 B 도징 보정 확정 후 재확인 |
