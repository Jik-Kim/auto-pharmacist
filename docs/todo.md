...
## gmp_skills [A 스킬]
- [ ] **[G2 기구 점검·실물 전 우선]** 손가락–그리퍼 본체 연결부의 열림 시 달그락거림·체결 상태·좌우 유격을 강사/장비 담당자와 확인. 백래시 여부는 미확정. 동일 60 mm 명령에서 닫힘 실측 평균 51.0 mm, 열림 평균 55.9 mm로 방향 차이 4.9 mm. 점검 및 운전 가능 확인 전 추가 실물 구동·보정 적용 보류 · 마감 9/21
